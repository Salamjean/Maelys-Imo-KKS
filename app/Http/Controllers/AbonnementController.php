...
class AbonnementController extends Controller
{
    public function abonnement()
    {
        ...
        return view('home.abonnement.proprietaire', [
            'montantAbonnement' => 100, // Montant en CFA
            'periodeAbonnement' => 'mois', // Période d'abonnement
            'proprietaire' => $proprietaire // Passer l'utilisateur à la vue
        ]);
    }
   ...
   public function abonnementAgence()
    {
        ...
        return view('home.abonnement.agence', [
            'montantAbonnement' => 100, // Montant en CFA
            'periodeAbonnement' => 'mois', // Période d'abonnement
            'agence' => $agence // Passer l'utilisateur à la vue
        ]);
    }
    ...
    public function activateAccountAgence(Request $request)
    {
        ...
        try {
            ...
            Log::info('Utilisateur récupéré:', ['id' => $agence->id, 'code_id' => $agence->code_id]);
    ...
    public function handleCinetPayNotificationAgence(Request $request)
{
    ...
    {
        $request->validate(['id' => 'required|exists:abonnements,id']);
        ...
        try {
            ...
            $abonnement->update([
                'statut' => 'actif',
                'date_debut' => now(),
                'date_fin' => now()->addMonth(), // 1 mois d'abonnement
                'notes' => 'Activé manuellement le '.now()->format('d/m/Y H:i')
            ]);
