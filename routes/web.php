...
// Connexion unifiée
Route::get('/se-connecter', [UnifiedLoginController::class, 'showLoginForm'])->name('login');
Route::post('/se-connecter', [UnifiedLoginController::class, 'authenticate'])->name('unified.authenticate');

// Réinitialisation de mot de passe unifiée
Route::get('/mot-de-passe/oublie', [UnifiedForgotPasswordController::class, 'showLinkRequestForm'])->name('unified.password.request');
Route::post('/mot-de-passe/email', [UnifiedForgotPasswordController::class, 'sendResetLinkEmail'])->name('unified.password.email');
Route::get('/mot-de-passe/reinitialiser/{code_id}/{token}', [UnifiedForgotPasswordController::class, 'showResetForm'])->name('unified.password.reset');
Route::post('/mot-de-passe/reinitialiser', [UnifiedForgotPasswordController::class, 'reset'])->name('unified.password.update');
...
Route::get('/details-bien/{id}', [BienController::class, 'details'])->name('bien.details');
