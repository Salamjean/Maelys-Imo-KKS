...
Route::middleware('auth:admin')->prefix('admin')->group(function () {
    ...
    //routes de gestion des agences partenaires
    Route::get('/agences/index',[AgenceController::class, 'index'])->name('agence.index');
    Route::get('/agences/create',[AgenceController::class, 'create'])->name('agence.create');
    ...
    Route::delete('/agences/{id}/destroy',[AgenceController::class, 'destroy'])->name('agence.destroy');
     ...
     //routes de gestion des locataires
     ...
     Route::get('/locataires/create',[LocataireController::class, 'createAdmin'])->name('locataire.admin.create');
 ...
 Route::prefix('admin/visites')->group(function() {
    Route::get('/visites',[VisiteController::class, 'adminIndex'])->name('visite.index');
    Route::post('/{visite}/confirm', [VisiteController::class, 'confirm'])->name('visites.confirm');
    Route::post('/{visite}/done', [VisiteController::class, 'markAsDone'])->name('visites.done');
    Route::post('/{visite}/cancel', [VisiteController::class, 'cancel'])->name('visites.cancel');
    Route::get('/{visite}', [VisiteController::class, 'show'])->name('visites.show');
...
Route::middleware('auth:agence')->prefix('agence')->group(function () {
    ...
    Route::get('/biens/create',[BienController::class, 'createAgence'])->name('bien.create.agence');
    ...
    Route::get('/locataires/create',[LocataireController::class, 'create'])->name('locataire.create');
    ...
    Route::prefix('accounting')->group(function(){
        ...
        Route::get('/create',[ComptableController::class,'create'])->name('accounting.create');
