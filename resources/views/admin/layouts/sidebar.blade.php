  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-proprio">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('owner.create.admin') }}">Ajout d'un propriétaire</a>
          </li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('owner.index.admin') }}">Liste des propriétaires</a>
          </li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="{{ route('bien.rentedAdmin') }}">Liste des biens loués</a>
          </li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="compt">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('accounting.create.admin') }}"> Ajout d'un membre
            </a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('accounting.index.admin') }}"> Liste du personnel
            </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#comm" aria-expanded="false" aria-controls="comm">
      ...
      <div class="collapse" id="comm">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('admin.commercial.create') }}"> Ajout d'un commercial
            </a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('admin.commercial.index') }}"> Liste des commerciaux
            </a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('admin.commercial.statistics') }}"> Statistiques
            </a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="local">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('locataire.admin.create') }}"> Ajout d'un locataire
            </a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('locataire.admin.index') }}"> Liste des locatiares
            </a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="paie">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ route('reversement.index.admin') }}">Reversement demandé
            </a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ route('reversement.completed.admin') }}"> Reversement
              effectué </a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="abon">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="{{ route('admin.abonnement.inactif') }}">Abonnés inactifs</a>
          </li>
        </ul>
      </div>
    </li>
