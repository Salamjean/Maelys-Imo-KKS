...
<div class="content-wrapper p-4" style="background: #f8fafc !important;">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.commercial.statistics') }}" class="btn btn-outline-secondary btn-icon-text mr-3 shadow-sm" style="border-radius: 12px;">
                <i class="mdi mdi-arrow-left"></i>
            </a>
            <div>
                <h2 class="font-weight-bold mb-0" style="color: #02245b;">Statistiques : {{ $commercial->name }}</h2>
                <p class="text-muted mb-0">ID: {{ $commercial->code_id }}</p>
            </div>
        </div>
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.commercial.statistics.pdf', $commercial->id) }}" class="btn btn-primary shadow-sm" style="background: #02245b; border: none; border-radius: 12px; padding: 12px 20px;">
                <i class="mdi mdi-file-pdf mr-2"></i> Exporter Rapport PDF
            </a>
        </div>
    </div>
