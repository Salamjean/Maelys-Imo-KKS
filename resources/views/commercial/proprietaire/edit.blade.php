...
<div class="col-12 grid-margin stretch-card mb-4">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('commercial.proprietaires.update', $proprietaire->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mt-4">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="{{ route('commercial.proprietaires.index') }}" class="btn btn-light">Annuler</a>
                        </div>
                    </div>
            </form>
        </div>
