...
<div class="col-12 grid-margin stretch-card mb-4">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{ route('commercial.agences.update', $agence->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <fieldset style="border: 2px solid black; padding: 20px; border-radius: 5px; margin-bottom: 20px;">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="{{ route('commercial.agences.index') }}" class="btn btn-light">Annuler</a>
                        </div>
                    </div>
                </fieldset>
            </form>
