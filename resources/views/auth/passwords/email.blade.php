            ...
            <div class="col-md-12 col-lg-5">
                <div class="uf-form-signin p-4 rounded shadow">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h1 class="text-white h3 mb-0">Réinitialiser le mot de passe</h1>
                        <p class="text-white-50 small mt-2">Entrez votre Code ID pour recevoir un lien de
                            réinitialisation.</p>
                    </div>

                    <!-- Formulaire -->
                    <form action="{{ route('unified.password.email') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="input-group uf-input-group input-group-lg mb-4">
                            ...
                            <input type="text" class="form-control" name="code_id" value="{{ old('code_id') }}"
                                placeholder="Votre Code ID (ex: AGT123456)" required autofocus>
                        </div>
                        ...
                        <div class="d-grid gap-3">
                            ...
                            <a href="{{ route('login') }}" class="btn btn-outline-light btn-lg py-3">
