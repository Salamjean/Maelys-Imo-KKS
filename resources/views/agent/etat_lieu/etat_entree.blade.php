        ...
        <div class="col-md-12">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card h-100" style="border-color: #02245b;">
                                <div class="card-header" style="background-color: rgba(2, 36, 91, 0.1);">
                                    <h4 class="mb-0" style="color: #02245b;"><i class="fas fa-home me-2"></i>Informations du bien</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <p><strong>Type:</strong> {{ $bien->type }}</p>
                                            <p><strong>Type d'utilisation:</strong> {{ $bien->utilisation }}</p>
                                            <p><strong>Ville:</strong> {{ $bien->commune }}</p>
                                        </div>
                                        <div class="col-6">
                                            <p><strong>Surface:</strong> {{ $bien->superficie }} m²</p>
                                            <p><strong>Pièces:</strong> {{ $bien->nombre_de_chambres + $bien->nombre_de_toilettes }} </p>
                    ...
                    <form method="POST" action="{{ route('etat.entree.store') }}" id="etat-lieux-form">
                        @csrf
