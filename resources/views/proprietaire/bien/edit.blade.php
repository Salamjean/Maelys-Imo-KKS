    ...
    <div class="col-12 grid-margin stretch-card mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('bien.update.owner', $bien->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            ...
                                            value="{{ old('avance', $bien->avance) }}" min="1" max="12" maxlength="2"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            ...
                                            value="{{ old('caution', $bien->caution) }}" min="1" max="12" maxlength="2"
                                            oninput="this.value=this.value.slice(0,2)"
                                            style="border: 1px solid black; border-radius: 5px;">
                                    </div>
                                    @error('caution')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="disponibilite" min="1" max="31"
                                        placeholder="Jour (1-31)" value="{{ old('disponibilite', $bien->date_fixe) }}"
