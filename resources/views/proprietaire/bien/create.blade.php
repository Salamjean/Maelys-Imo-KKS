    ...
    <div class="col-12 grid-margin stretch-card mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description text-center">Pour l'ajout d'un bien, veuillez renseigner toutes les informations
                    demandées ci-dessous</p>

                <form class="forms-sample" action="{{ route('bien.store.owner') }}" method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Commune"
                                        value="{{ old('commune') }}" name="commune"
                                        style="border: 1px solid black; border-radius: 5px;">
                                    @error('commune')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Nombre de chambres"
                                        value="{{ old('nombre_de_chambres') }}" name="nombre_de_chambres"
                                        style="border: 1px solid black; border-radius: 5px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Nombre de toilettes"
                                        value="{{ old('nombre_de_toilettes') }}" name="nombre_de_toilettes"
                                        style="border: 1px solid black; border-radius: 5px;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" value="{{ old('prix') }}"
                                            placeholder="Montant total" name="prix"
                                            style="border: 1px solid black; border-radius: 5px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            placeholder="Entrez le nombre de mois d'avance" name="avance" min="1" max="99"
                                            value="{{ old('avance') }}" maxlength="2"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            placeholder="Entrez le nombre de mois de caution" name="caution" min="1"
                                            max="99" value="{{ old('caution') }}" maxlength="2"
                                            oninput="this.value=this.value.slice(0,2)"
                                            style="border: 1px solid black; border-radius: 5px;">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="disponibilite" min="1" max="31"
                                        placeholder="Jour (1-31)" value="{{ old('disponibilite') }}"
                    ...
                    <fieldset style="border: 2px solid black; padding: 20px; border-radius: 5px; margin-bottom: 20px;">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" name="main_image" class="file-upload-default" required
                                            style="border: 1px solid black; border-radius: 5px;">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Choisir une image"
                                            style="border: 1px solid black; border-radius: 5px;">
                                        <span class="input-group-append">
                                            <button class="file-upload-browse btn text-white"
                                                style="background-color:#02245b" type="button">Télécharger</button>
                                        </span>
                                    </div>
                                    @error('main_image')
                                        <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" name="additional_images1" class="file-upload-default" required
                                            style="border: 1px solid black; border-radius: 5px;">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Choisir une image"
                                            style="border: 1px solid black; border-radius: 5px;">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" name="additional_images2" class="file-upload-default"
                                            style="border: 1px solid black; border-radius: 5px;">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Choisir une image"
                                            style="border: 1px solid black; border-radius: 5px;">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" name="additional_images3" class="file-upload-default"
                                            style="border: 1px solid black; border-radius: 5px;">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Choisir une image"
                                            style="border: 1px solid black; border-radius: 5px;">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" name="additional_images4" class="file-upload-default"
                                            style="border: 1px solid black; border-radius: 5px;">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Choisir une image"
                                            style="border: 1px solid black; border-radius: 5px;">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" name="additional_images5" class="file-upload-default"
                                            style="border: 1px solid black; border-radius: 5px;">
                                        <input type="text" class="form-control file-upload-info" disabled
                                            placeholder="Choisir une image"
                                            style="border: 1px solid black; border-radius: 5px;">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Vidéo 3D Interactive / Visite Virtuelle (Lien ou Code Iframe) <span
                                            class="text-muted">(Optionnel)</span></label>
                                    <textarea name="video_3d" class="form-control" rows="3"
                                        placeholder="Collez ici le lien ou le code d'intégration (iframe) de la visite virtuelle"
                                        style="border: 1px solid black; border-radius: 5px;">{{ old('video_3d') }}</textarea>
                                    <small class="text-muted">Vous pouvez mettre un lien YouTube, Matterport ou un code
                                        iframe.</small>
                                </div>
                                @error('video_3d')
                                    <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" value="{{ old('description') }}" rows="4" name="description"
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 text-center">
                            <button type="submit" class="btn text-white mr-2"
                                style="background-color: #02245b; color:white">Enregistrer</button>
                        </div>
                    </div>
                </form>
            </div>
