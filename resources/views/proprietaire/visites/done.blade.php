...
<div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title text-center">Historique des visites</h4>
        <p class="card-description text-center">
          Liste des visites déjà effectuée
        </p>
        <div class="mb-3">
                <input type="text" id="searchInput" class="form-control" placeholder="Rechercher un visite...">
        </div>
            ...
            <tbody>
                @forelse($visites as $visite)
                    ...
                    <tr class="text-center">
                        ...
                        <td><strong>{{ $visite->bien->proprietaire->name.' '.$visite->bien->proprietaire->prenom ?? 'Maelys-Imo' }}</strong></td>
                    </tr>
                @empty
                    <tr>
