    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-start" >
        ...
        <div class="navbar-brand-wrapper">
            ...
            <a class="navbar-brand brand-logo" href="{{ route('owner.dashboard') }}">
                <img src="{{ asset('storage/' . Auth::guard('owner')->user()->profil_image) }}"
            ...
            <div class="dropdown d-lg-none">
                ...
                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="mobileLogoDropdown">
                    <div class="dropdown-header text-center">
                        <h6 class="mb-0">{{ Auth::guard('owner')->user()->name }}</h6>
                        <small class="text-muted">{{ Auth::guard('owner')->user()->email }}</small>
                    </div>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('owner.dashboard') }}">
                        <i class="mdi mdi-home mr-2 text-primary"></i> Tableau de bord
                    </a>
                    <a class="dropdown-item" href="{{ route('owner.edit.profile') }}">
        ...
        <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Bienvenue chez {{ Auth::guard('owner')->user()->name }}</h4>
    </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown d-none d-lg-block">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                    ...
                    <span class="nav-profile-name">{{ Auth::guard('owner')->user()->name }}</span>
                </a>
