...
<div class="col-12 grid-margin stretch-card mb-4">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title text-center">Ajout d'un agent pour la gestion de vos biens</h4>
            <p class="card-description text-center">Pour l'ajout d'un agent, veuillez renseigner toutes les informations demandées ci-dessous</p>
            
            <form class="forms-sample" action="{{ route('accounting.store.owner') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
