            ...
            <div class="col-md-12 col-lg-5">
                <div class="uf-form-signin p-4 rounded shadow">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h1 class="text-white h3 mb-0">Connexion - Propriétaire</h1>
                    </div>
                    
                    <!-- Formulaire -->
                    <form action="{{ route('owner.authenticate') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="text-end mb-3">
                            <a href="{{ route('owner.request') }}" class="text-white">Mot de passe oublié ?</a>
                        </div>
