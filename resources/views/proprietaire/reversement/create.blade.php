            ...
            <div class="col-md-8 mx-auto">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('reversement.store') }}" method="POST" id="reversement-form"
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-6 col-sm-3 pr-2 pb-2">
                                            <div class="reseau-card border rounded text-center py-3 px-2 h-100"
                                                ...
                                                <span class="reseau-check" id="check-wave"
                                        ...
                                        <div class="col-6 col-sm-3 pr-2 pb-2">
                                            <div class="reseau-card border rounded text-center py-3 px-2 h-100"
                                                style="cursor:not-allowed;opacity:.45;position:relative;">
