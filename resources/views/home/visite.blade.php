            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page"><a
                            href="{{ route('bien.appartement') }}">Appartement</a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="card border-0 shadow-sm rounded-lg overflow-hidden mb-4">
                        <div class="row g-0">
                            <div class="col-md-6">
                                @if($bien->video_3d)
                                    <div class="video-3d-wrapper h-100"
                                        style="position: relative; min-height: 300px; background: #000; overflow: hidden;">
                                        @php $embedUrl = $bien->getVideo3dEmbedUrl(); @endphp
                                        @if(str_contains($embedUrl, '<iframe'))
                                            <div class="raw-iframe-container h-100">
                                                {!! $embedUrl !!}
                                            </div>
                                        @else
                                            <iframe src="{{ $embedUrl }}"
                                    ...
                                    <style>
                                        ...
                                        .video-3d-wrapper .raw-iframe-container iframe {
                                            position: absolute;
                                            top: 0;
                                            left: 0;
                                            width: 100%;
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between border-top pt-3">
                                        <div>
                                            <p><i class="fa fa-ruler-combined text-primary me-2"></i>
                                                {{ $bien->superficie }} m²</p>
                                            <p><i class="fa fa-bed text-primary me-2"></i> {{ $bien->nombre_de_chambres }}
                                                Chambres</p>
                                        </div>
                                        <div>
                                            <p><i class="fa fa-bath text-primary me-2"></i> {{ $bien->nombre_de_toilettes }}
                                                Toilettes</p>
                                            <p><i class="fa fa-car text-primary me-2"></i>
                                                {{ $bien->garage ? 'Oui' : 'Non' }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-light p-3 mt-3 rounded">
                                        ...
                                        <p class="mb-1"><strong>Loyer mensuel:</strong>
                                            {{ number_format($bien->prix, 0, ',', ' ') }} FCFA</p>
                                        @if($bien->avance)
                                            <p class="mb-1"><strong>Avance:</strong>
                                                {{ number_format($bien->avance, 0, ',', ' ') }} Mois</p>
                                        @endif
                                        @if($bien->caution)
                                            <p class="mb-1"><strong>Caution:</strong>
                                                {{ number_format($bien->caution, 0, ',', ' ') }} Mois</p>
                                        @endif
                                        <p class="mb-0"><strong> Date fixe de loyer:</strong> {{$bien->date_fixe }} des mois
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-floating">
                                                        <textarea class="form-control" placeholder="Message supplémentaire"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="date" class="form-control" id="date_visite"
                                                                name="date_visite" min="{{ date('Y-m-d') }}" required>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-floating">
                                                                <input type="time" class="form-control" id="heure_visite"
                                                                    name="heure_visite" min="08:00" max="18:00" required>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="col-12">
                                                                    <button class="btn py-3 px-5"
                                                                        style="background-color: #02245b; color:white; "
