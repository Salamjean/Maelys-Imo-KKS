...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn position-relative"
     data-wow-delay="0.1s"
     style="background-image: url('{{ asset('assets/images/bureau.jpg') }}'); background-size: cover; background-position: center;">
    ...
    <div class="container py-5 position-relative" style="z-index: 2;">
        <h1 class="display-3 text-white animated slideInRight">Bureaux</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb animated slideInRight mb-0">
                <li class="breadcrumb-item"><a href="/" class="text-white">Accueil</a></li>
                <li class="breadcrumb-item active text-white" aria-current="page">Bureau</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="position-relative w-75 mx-auto animated fadeInUp">
    <form action="{{ route('bien.terrain') }}" method="GET">
    <div class="row g-3">
        <div class="col-md-6">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-12 text-center py-5">
                <div class="alert alert-info">
                    Aucun bureau disponible pour le moment.
                </div>
            </div>
            @endforelse
        </div>
