...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn position-relative"
     data-wow-delay="0.1s"
     style="background-image: url('{{ asset('assets/images/appartement.jpg') }}'); background-size: cover; background-position: center;">
    ...
    <div class="container py-5 position-relative" style="z-index: 2;">
        <h1 class="display-3 text-white animated slideInRight">Appartements</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb animated slideInRight mb-0">
                <li class="breadcrumb-item"><a href="/" class="text-white">Accueil</a></li>
                <li class="breadcrumb-item active text-white" aria-current="page">Appartement</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="position-relative w-75 mx-auto animated fadeInUp">
    <form action="{{ route('bien.appartement') }}" method="GET">
    <div class="row g-3">
        <div class="col-md-6">
    ...
    <div class="text-center mt-3">
        <a href="{{ route('bien.appartement') }}" class="btn btn-outline-primary btn-sm">
...
<div class="container-xxl py-5">
    <div class="container px-lg-5">
        <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
            <h2 class="position-relative d-inline text-primary ps-4">Tous les appartements disponibles</h2>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="property-item rounded overflow-hidden" style="background-color: #f8f9fae4;">
                    ...
                    <div class="p-4 pb-0">
                        ...
                        <p><i class="fa fa-home text-primary me-2"></i>Agence : {{  optional($bien->agence)->name ?? 'Maelys-imo'}}</p>
                    </div>
