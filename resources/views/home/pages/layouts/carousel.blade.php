                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-10 text-start">
                                <p class="fs-5 fw-medium text-primary text-uppercase animated slideInRight">Type de bien</p>
                                <h1 class="display-1 text-white mb-5 animated slideInRight">Le description du bien</h1>
