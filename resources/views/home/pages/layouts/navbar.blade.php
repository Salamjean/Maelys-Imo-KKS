        ...
        <div class="col-lg-6 ps-5 text-start">
            <div class="h-100 d-inline-flex align-items-center text-white">
                ...
                <a class="btn btn-link text-light" target="_blank"
                    href="https://www.facebook.com/profile.php?id=61577304887475"><i class="fab fa-facebook-f"></i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div style="margin-left: 20px;" class="navbar-nav ms-auto p-4 p-lg-0 gap-2">
            <div class="d-flex align-items-center">
                <!-- Lien de connexion unique -->
                <a href="{{ route('login') }}" class="btn btn-primary font-bold px-3 text-white">
                    Se connecter
                </a>
            </div>
            <div class="d-flex align-items-center">
                <!-- Menu déroulant -->
                <select class="btn btn-primary font-bold px-3 text-white" style="width: auto;"
