    ...
    <div class="container py-5" style="width: 100%">
        <div class="row justify-content-center">
                    ...
                    <div class="card-body p-4">
                                ...
                                <button class="nav-link" id="historique-tab" data-bs-toggle="tab"
                                    ...
                                    @if ($totalEtats > 0)
                                        <span class="badge rounded-pill ms-1"
                                            style="background-color:#02245b">{{ $totalEtats }}</span>
                                    @endif
                                </button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="mainTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="overview" role="tabpanel">
                                ...
                                <div
                                    class="text-center mb-5 p-4 bg-light rounded-3 border border-2 border-dashed border-primary">
                                    <h4 class="mb-3 fw-bold text-primary"><i class="fas fa-qrcode me-2"></i>Code de
                                        vérification</h4>
                                    @if (isset($qrCodeBase64))
                                        <div class="position-relative d-inline-block">
                                            <img src="data:image/png;base64,{{ $qrCodeBase64 }}" alt="QR Code"
                                                class="img-fluid shadow-sm" style="max-width: 200px;">
                                        ...
                                        <div class="mt-3">
                                            <p class="mb-1"><span class="text-black">Code:</span> <span
                                                    class="fw-bold text-dark">{{ $verificationCode }}</span></p>
                                            <p class="mb-0"><span class="text-black">Expire à:</span> <span
                                                    class="fw-bold">{{ $expiresAt->format('d/m/Y H:i') }}</span></p>
                                        </div>
                                    @else
                                                ...
                                                <div class="d-flex align-items-center h-100">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0 fw-bold">
                                                            {{ number_format($locataire->bien->prix, 0, '', ' ') }} Fcfa</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    @if ($comptable->profile_image)
                                                        <div class="avatar me-3">
                                                            <img src="{{ asset('assets/images/Vatar.jpg') }}"
                                                    ...
                                                    <div class="flex-grow-1"
                                                        ...
                                                        <h5 class="mb-1">{{ $comptable->name }}
                                                            {{ $comptable->prenom }}</h5>
                                                        <p class="text-black small mb-2"><i
                                                                class="fas fa-briefcase me-1"></i> Agent immobilier</p>

                                                        <div class="d-flex flex-wrap gap-2">
                                                            <a href="tel:{{ $comptable->contact }}"
                                                                class="btn btn-sm btn-outline-primary rounded-pill">
                                                                <i class="fas fa-phone-alt me-1"></i>
                                                                {{ $comptable->contact }}
                                                            </a>
                                                            <a href="mailto:{{ $comptable->email }}"
                                                                class="btn btn-sm btn-outline-primary rounded-pill">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6 mx-auto">
                                                <div class="btn-group w-100" role="group">
                                                    @if ($etatLieu)
                                                        <button type="button"
                                                            class="btn btn-outline-primary {{ !$etatLieuSortie ? 'active' : '' }}"
                                                            id="btn-entree" data-etat="entree">
                                                            <i class="fas fa-sign-in-alt me-2"></i>État Entrée
                                                        </button>
                                                    @endif
                                                    @if ($etatLieuSortie)
                                                        <button type="button"
                                                            class="btn btn-outline-primary {{ !$etatLieu ? 'active' : '' }}"
                                                            id="btn-sortie" data-etat="sortie">
                                            ...
                                            <div id="etat-entree-container">
                                                ...
                                                <div class="d-flex justify-content-end mb-3">
                                                    <a href="{{ route('etat-lieu.agent.download', $etatLieu->id) }}"
                                                        ...
                                                        <i class="mdi mdi-file-pdf-box me-1"></i> Télécharger PDF état
                                                        d'entrée
                                                    </a>
                                                </div>
                                                                ...
                                                                <div class="etat-confirmation-container">
                                                                    @if ($etatLieu->status_etat_entre === 'Oui')
                                                                        <div class="d-flex align-items-center"
                                                                            ...
                                                                            <div>
                                                                                <h6 class="mb-0 text-success">État d'entrée
                                                                                    confirmé</h6>
                                                                                @if ($etatLieu->updated_at)
                                                                                    <small class="text-muted">Confirmé le:
                                                                                        {{ $etatLieu->updated_at->format('d/m/Y à H:i') }}</small>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                    @else
                                                                        <a href="#" id="confirm-entree-btn"
                                                                            data-etat-id="{{ $etatLieu->id }}"
                                                                            ...
                                                                            <div class="d-flex align-items-center"
                                                                                ...
                                                                                <div>
                                                                                    <h6 class="mb-0">Confirmation requise
                                                                                    </h6>
                                                                                    <small class="text-muted">Cliquez pour
                                                                                        vérifier et confirmer</small>
                                                                                </div>
                                                                            </div>
                                                                        </a>
                                                                    @endif
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card stat-card bg-light-info border-0 h-100">
                                                            <div class="card-body text-center p-3">
                                                                ...
                                                                <p class="mb-0 fw-bold">
                                                                    {{ $etatLieu->nombre_cle ?? 'Non spécifié' }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <ul class="nav nav-tabs mb-4" id="etatLieuTabs" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link active" id="communes-tab"
                                                            data-bs-toggle="tab" data-bs-target="#communes"
                                                    ...
                                                    @foreach ($etatLieu->chambres as $index => $chambre)
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link" id="chambre{{ $index }}-tab"
                                                                data-bs-toggle="tab"
                                                                data-bs-target="#chambre{{ $index }}"
                                                                type="button" role="tab">
                                                ...
                                                <div class="tab-content" id="etatLieuTabsContent">
                                                    ...
                                                    <div class="tab-pane fade show active" id="communes"
                                                        role="tabpanel">
            ...
            'DOUCHE ET SDB' => ['field' => 'douche', 'obs' => 'observation_douche'],
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                @if (isset($etatLieu->parties_communes[$fields['field']]))
                                                                                    <span
                                                                                        class="badge rounded-pill bg-{{ $etatLieu->parties_communes[$fields['field']] === 'bon' ? 'success' : 'danger' }}">
                                                                                        {{ ucfirst($etatLieu->parties_communes[$fields['field']]) }}
                                                                                    </span>
                                                                                @else
                                                                                    <span
                                                                                        class="badge rounded-pill bg-secondary">Non
                                                                                        renseigné</span>
                                                                                @endif
                                                                            </td>
                                                    ...
                                                    @foreach ($etatLieu->chambres as $index => $chambre)
                                                        <div class="tab-pane fade" id="chambre{{ $index }}"
                                                            role="tabpanel">
                                                            <div class="table-responsive">
                                                                <table class="table table-hover table-bordered">
                                                                    <thead class="table-light">
            ...
            'PLAFONDS' => ['field' => 'plafond', 'obs' => 'observation_plafond'],
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    @if (isset($chambre[$fields['field']]))
                                                                                        <span
                                                                                            class="badge rounded-pill bg-{{ $chambre[$fields['field']] === 'bon' ? 'success' : 'danger' }}">
                                        ...
                                        @if ($etatLieuSortie)
                                            <div id="etat-sortie-container"
                                                style="{{ $etatLieu ? 'display: none;' : '' }}">
                                                {{-- Bouton télécharger PDF sortie --}}
                                                <div class="d-flex justify-content-end mb-3">
                                                    <a href="{{ route('locataire.etat-lieux.sortie.download', $etatLieuSortie->id) }}"
                                                        class="btn btn-outline-danger btn-sm" target="_blank">
                                                        <i class="mdi mdi-file-pdf-box me-1"></i> Télécharger PDF état de
                                                        sortie
                                                    </a>
                                                </div>
                                                <div class="row g-3 mb-4">
                                                                    ...
                                                                    @if ($etatLieuSortie->status_sorti === 'Oui')
                                                                        <div class="d-flex align-items-center"
                                                                            ...
                                                                            <i
                                                                                class="fas fa-check-circle text-success me-2"></i>
                                                                            <div>
                                                                                <h6 class="mb-0 text-success">État de
                                                                                    sortie confirmé</h6>
                                                                                @if ($etatLieuSortie->updated_at)
                                                                                    <small class="text-muted">Confirmé le:
                                                                                        {{ $etatLieuSortie->updated_at->format('d/m/Y à H:i') }}</small>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                    @else
                                                                        <a href="#" id="confirm-sortie-btn"
                                                                            data-etat-id="{{ $etatLieuSortie->id }}"
                                                                            class="text-decoration-none">
                                                                            <div class="d-flex align-items-center"
                                                                                style="display:flex; justify-content:center">
                                                                                <i
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card stat-card bg-light-info border-0 h-100">
                                                            <div class="card-body text-center p-3">
                                                                ...
                                                                <h6 class="mb-1">Nombre de clés</h6>
                                                                <p class="mb-0 fw-bold">
                                                                    {{ $etatLieuSortie->nombre_cle ?? 'Non spécifié' }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <ul class="nav nav-tabs mb-4" id="etatLieuSortieTabs" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link active" id="communes-sortie-tab"
                                                            data-bs-toggle="tab" data-bs-target="#communes-sortie"
                                                            type="button" role="tab">
                                                            <i class="fas fa-door-open me-1"></i> Parties communes
                                                        </button>
                                                    </li>
                                                    @foreach ($etatLieuSortie->chambres as $index => $chambre)
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link"
                                                                id="chambre-sortie-{{ $index }}-tab"
                                                                data-bs-toggle="tab"
                                                                data-bs-target="#chambre-sortie-{{ $index }}"
                                                                type="button" role="tab">
                                                                <i class="fas fa-bed me-1"></i> Pièce {{ $index + 1 }}
                                                            </button>
                                                        </li>
                                                ...
                                                <div class="tab-content" id="etatLieuSortieTabsContent">
                                                    <!-- Onglet Parties communes -->
                                                    <div class="tab-pane fade show active" id="communes-sortie"
                                                        role="tabpanel">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover table-bordered">
                                                                <thead class="table-light">
            ...
            'DOUCHE ET SDB' => ['field' => 'douche', 'obs' => 'observation_douche'],
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                @if (isset($etatLieuSortie->parties_communes[$fields['field']]))
                                                                                    <span
                                                                                        class="badge rounded-pill bg-{{ $etatLieuSortie->parties_communes[$fields['field']] === 'bon' ? 'success' : 'danger' }}">
                                                    ...
                                                    @foreach ($etatLieuSortie->chambres as $index => $chambre)
                                                        <div class="tab-pane fade"
                                                            id="chambre-sortie-{{ $index }}" role="tabpanel">
                                                            <div class="table-responsive">
                                                                <table class="table table-hover table-bordered">
                                                                    <thead class="table-light">
                                                                        <tr>
                                        ...
                                        <div class="card border-0 shadow-sm text-center p-5">
                                            <div class="mb-3">
                                                <i class="mdi mdi-clipboard-text-outline"
                                                    style="font-size: 60px; color: #02245b; opacity: 0.4;"></i>
                                            </div>
                                            <h5 class="text-muted mb-2">État des lieux non encore effectué</h5>
                                            <p class="text-muted mb-0">L'état des lieux n'a pas encore été réalisé pour
                                                votre bien actuel.<br>Il sera visible ici dès qu'il sera rempli par votre
                                                agent ou gestionnaire.</p>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="historique" role="tabpanel">
                                ...
                                @if ($allEtatsEntree->count() + $allEtatsSortie->count() === 0)
                                    <div class="card border-0 shadow-sm text-center p-5">
                                        ...
                                        <p class="text-muted mb-0">Vos états des lieux apparaîtront ici dès qu'ils seront
                                            créés.</p>
                                    </div>
                                @else
                                    <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($allEtatsEntree as $el)
                                                    <tr>
                                                        ...
                                                        <td>{{ $el->created_at ? $el->created_at->format('d/m/Y') : '—' }}
                                                        </td>
                                                        <td>
                                                            @if ($el->status_etat_entre === 'Oui')
                                                                <span class="badge rounded-pill bg-success"><i
                                                                        class="fas fa-check me-1"></i>Confirmé</span>
                                                            @else
                                                                <span class="badge rounded-pill bg-warning text-dark"><i
                                                                        class="fas fa-clock me-1"></i>En attente</span>
                                                            @endif
                                                        </td>
                                                ...
                                                @foreach ($allEtatsSortie as $es)
                                                    <tr>
                                                        ...
                                                        <td>{{ $es->created_at ? $es->created_at->format('d/m/Y') : '—' }}
                                                        </td>
                                                        <td>
