...
<html lang="en">
  <head>
    ...
    <title>Inscrire un locataire</title>
    <!-- SweetAlert2 CSS -->
...
body::before {
  ...
  <body>
    <div class="uf-form-signin">
      ...
      <h1 class="text-white h3">Definir - accès - Locataire</h1>
      </div>
      <form class="mt-4" action="{{ route('locataire.validate', $email) }}" method="POST" id="registerForm">
        @csrf
        @method('POST')
