                                ...
                                <tr class="text-center pt-3" style="height: 30px">
                                    ...
                                    <td class="text-center ">
                                        <div class="btn-group gap-2" role="group">
                                            <a href="{{ route('locataire.edit', $locataire->id) }}"
                                            ...
                                            @endif
                                            @if ($locataire->status === 'Actif')
                                                <a href="{{ route('agence.demenagement.show', $locataire->id) }}"
                                                    class="btn btn-sm btn-danger" title="Déménagement">
                                                    <i class="mdi mdi-home"></i>
                                                </a>
                                            @endif
                                            <a href="{{ route('agence.demenagement.historique', $locataire->id) }}"
    ...
    <script>
        ...
        `);
            ...
            $('.change-status-btn').on('click', function() {
                ...
                form.attr('action',
                    "{{ route('locataires.updateStatus', ['locataire' => 'LOCATAIRE_ID']) }}".replace(
        ...
        $(document).on('click', '.attribuer-bien-btn', function() {
            ...
            `,
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('locataire.attribuer-bien.agence', ['locataire' => 'LOCATAIRE_ID']) }}"
