    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('agence.dashboard') }}" class="btn btn-outline-secondary btn-sm">
                    <i class="fas fa-arrow-left mr-1"></i> Retour
                </a>
            </div>
            <p class="card-description text-muted mb-4">Mettez à jour les informations de votre agence</p>
            
            <form class="forms-sample" method="POST" action="{{ route('agence.update.profile') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                        ...
                        <div class="form-group text-center" style="border: 1px solid black; border-radius: 5px; padding:20px">
                            <div class="profile-image-container mb-4">
                                @if($agence->profile_image)
                                    <img src="{{ asset('storage/'.$agence->profile_image) }}" 
                                ...
                                <div class="file-upload-wrapper">
                                    <label for="profile_image" class="btn btn-outline-primary btn-sm btn-block">
                                        ...
                                        {{ $agence->profile_image ? 'Changer la photo' : 'Ajouter une photo' }}
                                    </label>
                    ...
                    <div class="col-md-8" style="border: 2px solid black; padding: 20px; border-radius: 5px;">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Nom de l'agence <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control form-control-lg" id="name" name="name" 
                                           value="{{ old('name', $agence->name) }}" style="border: 1px solid black; border-radius: 5px;">
                                    @error('name')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="contact" name="contact" 
                                           value="{{ old('contact', $agence->contact) }}" style="border: 1px solid black; border-radius: 5px;">
                                    @error('contact')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="commune" name="commune" 
                                           value="{{ old('commune', $agence->commune) }}" style="border: 1px solid black; border-radius: 5px;">
                                    @error('commune')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-lg" id="adresse" name="adresse" 
                                      rows="2" style="border: 1px solid black; border-radius: 5px;">{{ old('adresse', $agence->adresse) }}</textarea>
                            @error('adresse')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
