<nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
      ...
      <div class="navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ route('agence.dashboard') }}"><img src="{{ asset('storage/' . Auth::guard('agence')->user()->profile_image) }}" style="width: 100px" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('agence.dashboard') }}"><img src="{{ asset('storage/' . Auth::guard('agence')->user()->profile_image) }}" style="width: 10px" alt="logo"/></a>
      </div>
      ...
      <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item nav-profile dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
            <img src="{{ asset('storage/' . Auth::guard('agence')->user()->profile_image) }}" alt="profile"/>
