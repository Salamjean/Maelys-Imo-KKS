<nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-start" >
        ...
        <div class="navbar-brand-wrapper">
            ...
            <a class="navbar-brand brand-logo" href="{{ route('agence.dashboard') }}">
                <img src="{{ asset('storage/' . Auth::guard('agence')->user()->profile_image) }}"
                    onerror="this.onerror=null; this.src='{{ asset('assets/images/agence.jpg') }}';" 
            ...
            <div class="dropdown d-lg-none">
                ...
                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="mobileLogoDropdown">
                    <div class="dropdown-header text-center">
                        ...
                        <small class="text-muted">{{ Auth::guard('agence')->user()->email }}</small>
                    </div>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('agence.dashboard') }}">
                        <i class="mdi mdi-home mr-2 text-primary"></i> Tableau de bord
                    </a>
                    <a class="dropdown-item" href="{{ route('agence.edit.profile') }}">
                        <i class="mdi mdi-account mr-2 text-primary"></i> Mon profil
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{{ route('agence.logout') }}">
                        <i class="mdi mdi-logout mr-2 text-primary"></i> Déconnexion
                    </a>
                </div>
            </div>
        </div>
        <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Bienvenue chez {{ Auth::guard('agence')->user()->name }}</h4>
    </div>
