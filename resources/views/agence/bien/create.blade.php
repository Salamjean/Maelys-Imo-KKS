    ...
    <div class="col-12 grid-margin stretch-card mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('bien.store.agence') }}" method="POST"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Nombre de chambres"
                                        name="nombre_de_chambres" style="border: 1px solid black; border-radius: 5px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" placeholder="Nombre de toilettes"
                                        name="nombre_de_toilettes" style="border: 1px solid black; border-radius: 5px;">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" placeholder="Montant total" name="prix"
                                            style="border: 1px solid black; border-radius: 5px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            ...
                                            max="99" maxlength="2" oninput="this.value=this.value.slice(0,2)"
                                            style="border: 1px solid black; border-radius: 5px;">
                                    </div>
                                </div>
                                @error('caution')
